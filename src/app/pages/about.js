...
import Adnan from '../../../public/assets/adnan.png';
import Image from 'next/image';
import Piyush from '../../../public/assets/piyush.jpg';
import Tiru from '../../../public/assets/tiru.jpg';
import Kunal from '../../../public/assets/kunal.jpg';
import Navbar from '../components/Navbar'; // Import Navbar component

export default function Landingpage() {
  return (
    <div className="relative min-h-screen bg-black p-8 flex flex-col justify-between">
      
      {/* Include Navbar */}
      {/* <Navbar /> Navbar is placed here to be visible on the landing page */}
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4 mb-8">
        ...
        <a href="#" className="group relative block bg-black">
          ...
          <div className="relative p-4 sm:p-6 lg:p-8">
            ...
            <div className="mt-32 sm:mt-48 lg:mt-64">
              <div className="translate-y-8 transform opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
                <p className="text-sm" style={{ color: '#b388ff' }}>NEGUS PRO MAX</p>
              </div>
            </div>
          </div>
        </a>
        ...
        <a href="#" className="group relative block bg-black">
          ...
          <div className="relative p-4 sm:p-6 lg:p-8">
            ...
            <div className="mt-32 sm:mt-48 lg:mt-64">
              <div className="translate-y-8 transform opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
                <p className="text-sm" style={{ color: '#b388ff' }}>Rehne de</p>
              </div>
            </div>
          </div>
        </a>
        ...
        <a href="#" className="group relative block bg-black">
          ...
          <div className="relative p-4 sm:p-6 lg:p-8">
            ...
            <div className="mt-32 sm:mt-48 lg:mt-64">
              <div className="translate-y-8 transform opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
                <p className="text-sm" style={{ color: '#b388ff' }}>Likes to have poha for breakfast!</p>
              </div>
            </div>
          </div>
        </a>
      ...
      <footer className="flex justify-center items-center p-4">
        <p className="text-sm" style={{ color: '#b388ff' }}>© 2024 TechNomads. All rights reserved.</p>
      </footer>
    </div>
  );
}
